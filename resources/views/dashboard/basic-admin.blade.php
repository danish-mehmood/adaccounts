      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form id="paginate_form" action="{{route('paginator')}}" method="POST">  
              @csrf
            @if($prev_link != "")
            {{-- <a href="{{route('paginator',$prev_link) }}"><button class="prev">Prev</button></a> --}}
        ...
        <form id="paginate_form2" action="{{route('paginator')}}" method="POST">
          @csrf 
          @if($next_link != "")
